...
/**
 * @author <a href="mailto:yaotrue@163.com">yaotrue</a> 2018年4月27日 上午10:07:55
 */
public class CaptchaUtil {
	...
	private static String[] letters = new String[] { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "m", "n",
			"p", "q", "r", "s", "t", "u", "v", "w", "x", "y" };
	...
	static {
		...
		try {
			...
			// File(Thread.currentThread().getContextClassLoader().getResource("").getPath()+"timesbd.ttf"));
	...
	private static Font getFont() {
		...
		// fontAT.scale(1, 1);
		// fontAT.shear(0d,rand.nextBoolean() ? Math.toRadians(rotate) :
