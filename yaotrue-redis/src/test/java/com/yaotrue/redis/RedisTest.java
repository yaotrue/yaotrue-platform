...
//    private static String AUTH = "123456";
    ...
    static {
        try {
            ...
            jedisPool = new JedisPool(config, ADDR, PORT, 3000, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        RedisTest.testString(jedis);
        RedisTest.testMap(jedis);
        RedisTest.testList(jedis);
        RedisTest.testSet(jedis);

        RedisTest.close(jedis);
    }
